        ...
        <div className="results-section">
          ...
          {recommendations && !loading && (
            <div className="recommendations-results">
              ...
              {/* AI Fertilizer Suggestions */}
              {recommendations.ai_suggestions && (
                <div className="ai-suggestions-section">
                  <h2>🤖 AI Crop Management Suggestions</h2>
                  <p className="ai-suggestions-subtitle">
                    {recommendations.ai_suggestions.source
                      ? `Generated by ${recommendations.ai_suggestions.source} AI for ${recommendations.top_recommendation}`
                      : recommendations.ai_suggestions.message || 'AI suggestions unavailable'}
                  </p>
                  <div className="ai-suggestions-grid">
                    {(recommendations.ai_suggestions.suggestions || []).map((suggestion, index) => (
              ...
              {showPriceDashboard && (
                <div className="price-dashboard-wrapper">
                  ...
                  <PricePredictionDashboard 
                    ...
                    mlScore={recommendations.crop_recommendations?.[0]?.score}
                  />
                </div>
              )}
            </div>
